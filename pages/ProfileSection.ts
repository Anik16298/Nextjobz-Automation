...
export class ProfileSection extends BasePage {
    logoutMenuItem: any /* Locator */;

    profileAvatar: any /* Locator */;
    profileDropdown: any /* Locator */;
    userName: any /* Locator */;
    profileMenuItem: any /* Locator */;
    dashboardMenuItem: any /* Locator */;
    savedJobzMenuItem: any /* Locator */;
    recommendedJobzMenuItem: any /* Locator */;
    appliedJobzMenuItem: any /* Locator */;
    enrolledTrainingsMenuItem: any /* Locator */;
    settingsMenuItem: any /* Locator */;
    ...
    async verifyMenuItemsVisible(): Promise<Record<string, boolean>> {
        await this.openProfileMenu();
