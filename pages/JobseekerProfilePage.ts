...
export class JobseekerProfilePage extends BasePage {
    url: any /* Locator */;
    personalDetailsSection: any /* Locator */;
    careerSnapshotSection: any /* Locator */;
    workExperienceSection: any /* Locator */;
    educationSection: any /* Locator */;
    skillsSection: any /* Locator */;
    trainingSection: any /* Locator */;
    projectsSection: any /* Locator */;
    volunteerSection: any /* Locator */;
    portfolioSection: any /* Locator */;
    preferencesSection: any /* Locator */;
    languageSection: any /* Locator */;
    referenceSection: any /* Locator */;
    otherInfoSection: any /* Locator */;
    addExperienceBtn: any /* Locator */;
    addEducationBtn: any /* Locator */;
    addSkillBtn: any /* Locator */;
    addCertificationBtn: any /* Locator */;
    addProjectBtn: any /* Locator */;
    addVolunteerBtn: any /* Locator */;
    addLinkBtn: any /* Locator */;
    addAccomplishmentBtn: any /* Locator */;
    addLanguageBtn: any /* Locator */;
    addReferenceBtn: any /* Locator */;
    saveBtn: any /* Locator */;
    cancelBtn: any /* Locator */;
    profilePercentage: any /* Locator */;
    editModal: any /* Locator */;
    ...
    constructor(page: Page) {
        ...
        this.addProjectBtn = page.getByRole('button', { name: /Add Another Project/i });
        this.addVolunteerBtn = page.getByRole('button', { name: /Add Another Volunteer/i });
        this.addLinkBtn = page.getByRole('button', { name: /Add Another Link/i });
        this.addAccomplishmentBtn = page.getByRole('button', { name: /Add Another Accomplishment/i });
        this.addLanguageBtn = page.getByRole('button', { name: /Add Another Language/i });
    ...
    async updatePersonalDetails(details: { bio?: string; location?: string }) {
    ...
    async verifyAllSectionsVisible(): Promise<Record<string, boolean>> {
        const sections = [
    ...
    async getProfileCompletion(): Promise<string> {
